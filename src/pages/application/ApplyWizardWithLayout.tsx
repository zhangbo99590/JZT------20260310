...
const ApplyWizardWithLayout: React.FC = () => {
  ...
  const [qualificationDrawerVisible, setQualificationDrawerVisible] =
    useState(false);

  // 获取资质名称的辅助函数
  const getQualificationLabel = (value: string) => {
    const qualification = QUALIFICATION_DATA.flatMap(
      (g) => g.qualifications,
  ...
  const beforeUpload = (file: RcFile) => {
    ...
    if (!isValidFormat) {
      message.error(
        "文件格式不符，请上传PDF、DOC、DOCX、XLS、XLSX、PNG或JPG格式的文件",
      );
  ...
  const renderPreviewModal = () => {
    ...
    const previewData = {
      ...
      overview: {
        background:
          "随着国家对科技创新的重视，我司积极响应号召，加大研发投入，提升核心竞争力。本项目旨在通过技术攻关，解决行业痛点，实现技术突破。",
        objectives:
          "1. 完成核心技术研发；2. 申请发明专利5项；3. 实现销售收入5000万元。",
        content:
          "主要内容包括：1. 核心算法优化；2. 系统架构升级；3. 应用场景拓展。",
        route:
          "采用敏捷开发模式，结合大数据分析与人工智能技术，分阶段推进项目实施。",
      },
      plan: [
      ...
      budget: [
        { item: "设备费", amount: 50.0, desc: "购置服务器、开发终端等" },
        { item: "材料费", amount: 20.0, desc: "研发耗材、元器件等" },
        { item: "测试费", amount: 10.0, desc: "第三方软件测试服务" },
        { item: "差旅费", amount: 5.0, desc: "项目调研、会议差旅" },
        { item: "劳务费", amount: 100.0, desc: "研发人员薪资、专家咨询费" },
        { item: "其他", amount: 15.0, desc: "出版/知识产权/会议等" },
      ],
      outcomes: {
      ...
      risks: [
        {
          risk: "技术风险",
          countermeasure: "加强技术调研，引进高端人才，建立技术专家库。",
        },
        {
          risk: "市场风险",
          countermeasure: "深入市场调研，灵活调整营销策略，拓展多元化市场。",
        },
        {
          risk: "管理风险",
          countermeasure: "完善项目管理制度，强化过程监控，落实责任到人。",
        },
      ],
      attachments: [
        "营业执照副本.pdf",
      ...
      series: [
        {
          type: "pie",
          radius: "50%",
          data: previewData.budget.map((item) => ({
            value: item.amount,
            name: item.item,
          })),
          emphasis: {
    ...
    return (
      ...
      >
        <Watermark content={["仅供预览", "JZT System"]} gap={[100, 100]}>
          <div
            style={{ padding: "24px 40px", background: "#fff", minHeight: 800 }}
          >
            {/* 封面 */}
            <div
              style={{
            ...
            >
              ...
              >
                ...
                <Descriptions.Item label="统一社会信用代码">
                  {previewData.basicInfo.creditCode}
                </Descriptions.Item>
                <Descriptions.Item label="申请日期">
                  {previewData.basicInfo.date}
                </Descriptions.Item>
              </Descriptions>
            </div>
            ...
            <div style={{ marginBottom: 32 }}>
              <Typography.Title
                level={4}
                style={{ borderLeft: "4px solid #1890ff", paddingLeft: 12 }}
              >
                一、项目基本信息
              </Typography.Title>
              <Descriptions bordered column={2}>
                <Descriptions.Item label="项目名称" span={2}>
                  {previewData.basicInfo.projectName}
                </Descriptions.Item>
                <Descriptions.Item label="申报单位" span={2}>
                  {previewData.basicInfo.applicant}
                </Descriptions.Item>
                <Descriptions.Item label="项目负责人">
                  {previewData.basicInfo.legalPerson}
                </Descriptions.Item>
                <Descriptions.Item label="联系电话">
                  {previewData.basicInfo.phone}
                </Descriptions.Item>
                <Descriptions.Item label="联系人">
                  {previewData.basicInfo.contact}
                </Descriptions.Item>
                <Descriptions.Item label="通讯地址">
                  {previewData.basicInfo.address}
                </Descriptions.Item>
              </Descriptions>
            </div>
            ...
            <div style={{ marginBottom: 32 }}>
              ...
              <div style={{ textIndent: "2em", lineHeight: 1.8 }}>
                <Paragraph>
                  <Text strong>1. 建设背景：</Text>
                  {previewData.overview.background}
                </Paragraph>
                <Paragraph>
                  <Text strong>2. 建设目标：</Text>
                  {previewData.overview.objectives}
                </Paragraph>
                <Paragraph>
                  <Text strong>3. 主要内容：</Text>
                  {previewData.overview.content}
                </Paragraph>
                <Paragraph>
                  <Text strong>4. 技术路线：</Text>
                  {previewData.overview.route}
                </Paragraph>
              </div>
            </div>
            ...
            <div style={{ marginBottom: 32 }}>
              ...
              <div style={{ padding: "0 24px" }}>
                <Timeline
                  items={previewData.plan.map((item) => ({
                    color: "blue",
                    children: (
                      <>
                        <Text strong>{item.date}</Text> {item.children}
                      </>
                    ),
                  }))}
                />
            ...
            <div style={{ marginBottom: 32 }}>
              ...
              <Descriptions bordered column={1}>
                <Descriptions.Item label="技术指标">
                  {previewData.outcomes.tech}
                </Descriptions.Item>
                <Descriptions.Item label="经济效益">
                  {previewData.outcomes.economic}
                </Descriptions.Item>
                <Descriptions.Item label="社会效益">
                  {previewData.outcomes.social}
                </Descriptions.Item>
              </Descriptions>
            </div>
      ...
      <div style={{ paddingBottom: DESIGN_TOKENS.spacing.lg }}>
        ...
        >
          <Descriptions column={3} layout="vertical">
            <Descriptions.Item label="企业名称">
              {projectInfo?.companyName || "深圳市创新科技有限公司"}
            </Descriptions.Item>
            <Descriptions.Item label="统一社会信用代码">
              {projectInfo?.creditCode || "91440300MA5XXXXXX"}
            </Descriptions.Item>
            <Descriptions.Item label="法定代表人">
              {projectInfo?.legalPerson || "张三"}
            </Descriptions.Item>
        ...
        >
          ...
          <Form.Item
            name="companyName"
            hidden
            initialValue={projectInfo?.companyName || "深圳市创新科技有限公司"}
          >
            <Input />
          </Form.Item>
          <Form.Item
            name="creditCode"
            hidden
            initialValue={projectInfo?.creditCode || "91440300MA5XXXXXX"}
          >
            <Input />
          </Form.Item>
          <Form.Item
            name="legalPerson"
            hidden
            initialValue={projectInfo?.legalPerson || "张三"}
          >
            <Input />
          </Form.Item>
          ...
          >
            ...
            >
              <Input
                ...
                value={getSelectedQualificationsText(
                ...
                suffix={
                  <Space>
                    {form.getFieldValue("projectType")?.length > 0 && (
                      <Tag color="blue">
                        {form.getFieldValue("projectType").length}
                      </Tag>
                    )}
                    <Button
                      type="link"
            ...
            <div>
              <Title
                ...
                style={{
                  ...
                  borderLeft: `3px solid ${DESIGN_TOKENS.colors.warning}`,
                  paddingLeft: 8,
                }}
              >
                资产负债数据
        ...
        <div>
          ...
          >
            ...
            <p className="ant-upload-hint">
              支持PDF、DOC、DOCX、XLS、XLSX、PNG、JPG格式，文件大小不超过10MB
            </p>
          </Upload.Dragger>
        </div>
  ...
  const renderStep3 = () => {
    return (
      <Card title="审核提交" style={{ marginBottom: DESIGN_TOKENS.spacing.md }}>
        ...
        <div
          style={{ border: "1px solid #f0f0f0", borderRadius: 4, padding: 24 }}
        >
            ...
            <Row gutter={[48, 24]}>
              <Col span={12}>
                ...
                <div style={{ fontSize: 16, fontWeight: 500 }}>
                  {formData.companyName || "深圳市创新科技有限公司"}
                </div>
              </Col>
              <Col span={12}>
                <div style={{ marginBottom: 8, color: "#999" }}>申报类型</div>
                <div style={{ fontSize: 16, fontWeight: 500 }}>
                  {formData.projectType === "type1"
                    ? "国家高新技术企业认定"
                    : formData.projectType === "type2"
                      ? "深圳市技术攻关项目"
                      : "企业技术中心认定"}
                </div>
              </Col>
