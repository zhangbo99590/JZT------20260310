...
const mockMyApplications: MyApplicationItem[] = [
  {
    ...
    progress: 60,
    supportDescription:
      "支持高新技术企业发展，提供税收优惠和资金扶持，促进企业技术创新和产业升级",
    region: "北京市",
    amount: "最高50万元",
    thumbnail:
  ...
  },
  {
    ...
    subsidyAmount: "资质认定",
    supportDescription:
      "认定科技型中小企业，享受研发费用加计扣除等优惠政策，提升企业创新能力",
    region: "全国",
    amount: "资质认定",
    thumbnail:
  ...
  },
  {
    ...
    supportDescription:
      "企业研发费用按175%在税前扣除，减轻企业税负，鼓励技术创新投入",
    region: "北京市",
    amount: "税收减免",
    thumbnail:
  ...
  },
  {
    ...
    deadline: "2026-04-15",
    supportDescription:
      "支持专业化、精细化、特色化、新颖化的中小企业发展，提供资金和政策扶持",
    region: "北京市",
    amount: "最高100万元",
    thumbnail:
  ...
  },
  {
    ...
    amount: "最高500万元",
    thumbnail:
      "https://gw.alipayobjects.com/zos/rmsportal/nxkuOJlFJuAUhzlMCEjg.png",
  },
  {
    id: "a8",
    projectId: "8",
...
const OptimizedMyApplications: React.FC = () => {
  ...
  const statusCounts = useMemo(() => {
    return {
      ...
      draft: mockMyApplications.filter((item) => item.status === "draft")
        .length,
      to_submit: mockMyApplications.filter(
        (item) => item.status === "to_submit",
      ).length,
      under_review: mockMyApplications.filter(
        (item) => item.status === "under_review",
      ).length,
      needs_revision: mockMyApplications.filter(
        (item) => item.status === "needs_revision",
      ).length,
      approved: mockMyApplications.filter((item) => item.status === "approved")
        .length,
      rejected: mockMyApplications.filter((item) => item.status === "rejected")
        .length,
      expired: mockMyApplications.filter((item) => item.status === "expired")
        .length,
    };
  }, []);
          ...
          {statusItems.map((item) => (
            <div
              ...
              style={{
                ...
                backgroundColor:
                  selectedStatus === item.key ? "#1890ff" : "transparent",
              ...
              <Col xs={24} sm={12} md={8}>
                <Space direction="vertical" size={4} style={{ width: "100%" }}>
                  ...
                  <Select
                    ...
                    onChange={(value) =>
                      setFilters({ ...filters, policyLevel: value })
                    }
                    allowClear
                  >
