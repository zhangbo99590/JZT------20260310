...
const MyServices: React.FC = () => {
        ...
        return (
          <Space size={4}>
            <Button
              ...
              icon={<EditOutlined />}
              onClick={() =>
                navigate(`/industry/service-match/publish?id=${record.id}`)
              }
            >
              编辑
            </Button>
        ...
        return (
          <Space size={4}>
            <Button
              ...
              icon={<EyeOutlined />}
              onClick={() =>
                navigate(`/industry/service-match/detail/${record.id}`)
              }
            >
              查看
            </Button>
            <Button
              type="link"
              size={size}
              style={{ ...style, color: THEME.textHint }}
              icon={<UndoOutlined />}
        ...
        return (
          <Space size={4}>
            ...
            <Button
              ...
              style={style}
              icon={<ReloadOutlined />}
              onClick={() => handleRepublish(record.id)}
            >
              重新发布
            </Button>
          </Space>
  ...
  const columns = [
    { title: "序号", dataIndex: "key", width: 60, align: "center" as const },
    {
      ...
      dataIndex: "title",
      render: (text: string) => (
        <span style={{ fontWeight: 500, color: THEME.textTitle }}>{text}</span>
      ),
    },
    ...
    { title: "状态", dataIndex: "status", width: 100, render: getStatusTag },
    {
      ...
      width: 160,
      style: { color: THEME.textHint, fontSize: "12px" },
    },
    {
      title: "操作",
      key: "action",
