  ...
  const dataSource = [
    {
      ...
      dimension: "所在地区",
      ...items.reduce(
        (acc, item, idx) => ({ ...acc, [`item_${idx}`]: item.region }),
        {},
      ),
    },
    {
    ...
    },
    {
      ...
      type: "rate",
      ...items.reduce(
        (acc, item, idx) => ({ ...acc, [`item_${idx}`]: item.score }),
        {},
      ),
    },
    {
      ...
      type: "tags",
      ...items.reduce(
        (acc, item, idx) => ({ ...acc, [`item_${idx}`]: item.tags }),
        {},
      ),
    },
    {
      ...
      dimension: "需求/业务",
      ...items.reduce(
        (acc, item, idx) => ({ ...acc, [`item_${idx}`]: item.scope }),
        {},
      ),
    },
    {
      ...
      dimension: "预算/规模",
      ...items.reduce(
        (acc, item, idx) => ({ ...acc, [`item_${idx}`]: item.budget || "-" }),
        {},
      ),
    },
  ];
