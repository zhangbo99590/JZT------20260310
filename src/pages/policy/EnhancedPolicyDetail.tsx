...
const EnhancedPolicyDetail: React.FC = () => {
  ...
  const mockPolicyData: PolicyDetailData = {
    ...
    funding: '最高500万元',
    type: '技术创新',
    description: '为推动北京市节能减排工作，鼓励企业实施节能技术改造项目，对符合条件的节能改造项目给予资金奖励。支持企业采用先进节能技术和设备，提升能源利用效率，降低能源消耗，促进绿色低碳发展。',
    policyBasis: '《北京市节能减排综合工作方案》《北京市促进节能技术改造专项资金管理办法》',
    ...
    return {
      ...
      tooltip: {
        ...
        formatter: (params: any) => {
          const indicators = ['资金力度', '申报难度', '获批率', '竞争程度', '匹配度'];
        ...
        <Row gutter={[24, 24]}>
          ...
          <Col xs={24} lg={16}>
            ...
            <Card
              ...
              title={
                <Space>
                  <CalendarOutlined style={{ fontSize: 18, color: isExpired ? '#ff4d4f' : '#1890ff' }} />
                  <Text strong style={{ fontSize: 16 }}>申报状态提醒</Text>
            ...
            >
              <Space direction="vertical" size={16} style={{ width: '100%' }}>
                <Row gutter={24}>
                  <Col span={8}>
                    <Space direction="vertical" size={4}>
                      ...
                      <Text strong style={{ fontSize: 16, color: isExpired ? '#ff4d4f' : '#000' }}>
                        {policyData.deadline}
                      </Text>
                    </Space>
                  </Col>
                  <Col span={8}>
                    <Space direction="vertical" size={4}>
                      ...
                      <Text strong style={{ 
                        fontSize: 20, 
                        color: isExpired ? '#ff4d4f' : remainingDays <= 7 ? '#faad14' : '#52c41a' 
                      }}>
                ...
                <div>
                  <Text type="secondary" style={{ marginBottom: 8, display: 'block' }}>申报进度</Text>
                  <Progress
                    percent={isExpired ? 100 : status === 'in_progress' ? 50 : 0}
                ...
                {status === 'in_progress' && (
                  <Alert
                    message="当前审核节点"
                    description={policyData.currentProgress || '政策申报材料准备阶段，请及时提交申报材料'}
                    type="info"
                    showIcon
            ...
            <Card
              ...
              extra={
                <Button type="link" onClick={() => message.info('展开更多内容')}>
                  查看详情
                </Button>
              }
            ...
            <Card
              title={
                <Space>
                  ...
                  <Text strong style={{ fontSize: 16 }}>申报材料清单</Text>
                </Space>
              }
              style={{ marginBottom: 24, borderRadius: 8, boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}
            >
            ...
            <Card
              title={
                <Space>
                  ...
                  <Text strong style={{ fontSize: 16 }}>办理流程</Text>
                </Space>
              }
              style={{ marginBottom: 24, borderRadius: 8, boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}
            >
            ...
            <Card
              title={
                <Space>
                  ...
                  <Text strong style={{ fontSize: 16 }}>联系方式</Text>
                </Space>
              }
              style={{ marginBottom: 24, borderRadius: 8, boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}
            >
            ...
            >
              <Space direction="vertical" size={16} style={{ width: '100%' }}>
                <div style={{ textAlign: 'center' }}>
                  ...
                  <Title level={4} style={{ color: '#fff', margin: 0 }}>快速申报通道</Title>
