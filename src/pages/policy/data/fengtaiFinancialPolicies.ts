...
export const fengtaiFinancialPolicies: PolicyFileData[] = [
  {
    ...
    originalTitle: '北京市丰台区人民政府关于印发"十四五"时期丰台区金融业发展规划的通知',
    tags: [
      { text: '产业规划', type: 'category', color: '#faad14', bgColor: '#fffbe6' },
    ...
    matchScore: 98,
    content: '为深入贯彻落实党中央、国务院关于金融工作的决策部署，推动丰台区金融业高质量发展，根据《北京市"十四五"时期金融业发展规划》，结合丰台区实际，制定本规划。丰台区金融服务办公室将统筹推进金融业发展各项工作，重点支持金融科技创新发展。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_002',
    title: '丰台区发展和改革委员会关于公开征集丰台区互联网金融风险监测预警服务机构的公告',
    originalTitle: '丰台区发展和改革委员会关于公开征集丰台区互联网金融风险监测预警服务机构的公告',
    tags: [
      { text: '申报通知', type: 'announcement', color: '#ff7a45', bgColor: '#fff2e8' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 95,
    content: '为加强丰台区互联网金融风险防控工作，建立健全风险监测预警机制，现面向社会公开征集互联网金融风险监测预警服务机构。丰台区金融服务办公室负责具体实施工作，重点关注金融科技领域的风险防控。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_003',
    title: '丰台区金融业发展专项资金管理办法',
    originalTitle: '北京市丰台区人民政府办公室关于印发丰台区金融业发展专项资金管理办法的通知',
    tags: [
      { text: '奖励文件', type: 'category', color: '#f5222d', bgColor: '#fff1f0' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 97,
    content: '为规范丰台区金融业发展专项资金使用管理，提高资金使用效益，支持金融业健康发展，制定本办法。专项资金重点支持在丰台区注册的金融机构、金融科技企业等，由丰台区金融服务办公室负责资金管理和项目审核。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_004',
    title: '丰台区促进金融科技创新发展若干措施',
    originalTitle: '北京市丰台区人民政府关于印发丰台区促进金融科技创新发展若干措施的通知',
    tags: [
      { text: '扶持政策', type: 'category', color: '#52c41a', bgColor: '#f6ffed' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 96,
    content: '为深入贯彻落实国家金融科技发展战略，推动丰台区金融科技产业创新发展，营造良好的金融科技发展环境，制定本措施。重点支持人工智能、区块链、大数据等技术在金融领域的应用创新，丰台区金融服务办公室统筹实施相关扶持政策。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_005',
    title: '丰台区金融机构落户奖励实施细则',
    originalTitle: '北京市丰台区金融服务办公室关于印发丰台区金融机构落户奖励实施细则的通知',
    tags: [
      { text: '奖励文件', type: 'category', color: '#f5222d', bgColor: '#fff1f0' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 94,
    content: '为吸引优质金融机构在丰台区落户发展，优化区域金融生态环境，根据相关政策规定，制定本实施细则。对在丰台区新设立或迁入的金融机构给予落户奖励，丰台区金融服务办公室负责奖励资金的审核发放工作。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_006',
    title: '丰台区小微企业金融服务创新试点工作方案',
    originalTitle: '北京市丰台区人民政府办公室关于印发丰台区小微企业金融服务创新试点工作方案的通知',
    tags: [
      { text: '试点方案', type: 'category', color: '#722ed1', bgColor: '#f9f0ff' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 93,
    content: '为深入推进小微企业金融服务创新，缓解小微企业融资难融资贵问题，根据国家和北京市相关政策要求，结合丰台区实际，制定本工作方案。丰台区金融服务办公室会同相关部门共同推进试点工作实施。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_007',
    title: '丰台区绿色金融发展支持政策',
    originalTitle: '北京市丰台区人民政府关于印发丰台区绿色金融发展支持政策的通知',
    tags: [
      { text: '支持政策', type: 'category', color: '#13c2c2', bgColor: '#e6fffb' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 91,
    content: '为推动丰台区绿色金融发展，支持绿色产业和项目融资，促进经济社会可持续发展，制定本支持政策。重点支持绿色信贷、绿色债券、绿色保险等金融产品创新，丰台区金融服务办公室负责政策实施和监督管理。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_008',
    title: '丰台区数字金融产业园区建设实施方案',
    originalTitle: '北京市丰台区人民政府办公室关于印发丰台区数字金融产业园区建设实施方案的通知',
    tags: [
      { text: '建设方案', type: 'category', color: '#eb2f96', bgColor: '#fff0f6' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 92,
    content: '为加快推进丰台区数字金融产业发展，打造具有区域特色的数字金融产业集聚区，根据北京市数字经济发展规划，制定本实施方案。园区将重点引进金融科技、数字支付等领域的优质企业，丰台区金融服务办公室参与园区运营管理。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_009',
    title: '丰台区金融人才引进和培养办法',
    originalTitle: '北京市丰台区人民政府关于印发丰台区金融人才引进和培养办法的通知',
    tags: [
      { text: '人才政策', type: 'category', color: '#fa8c16', bgColor: '#fff7e6' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 89,
    content: '为加强丰台区金融人才队伍建设，吸引和培养高层次金融人才，推动金融业高质量发展，制定本办法。重点引进金融科技、风险管理、资产管理等领域的专业人才，丰台区金融服务办公室负责人才认定和奖励发放。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_010',
    title: '丰台区金融风险防控专项行动方案',
    originalTitle: '北京市丰台区人民政府办公室关于印发丰台区金融风险防控专项行动方案的通知',
    tags: [
      { text: '行动方案', type: 'category', color: '#a0d911', bgColor: '#fcffe6' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 88,
    content: '为切实防范化解金融风险，维护区域金融稳定，保护金融消费者合法权益，根据国家和北京市金融监管要求，制定本专项行动方案。丰台区金融服务办公室牵头组织实施，重点加强对金融科技等新兴业态的风险监测。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_011',
    title: '丰台区普惠金融服务体系建设指导意见',
    originalTitle: '北京市丰台区人民政府关于印发丰台区普惠金融服务体系建设指导意见的通知',
    tags: [
      { text: '指导意见', type: 'category', color: '#597ef7', bgColor: '#f0f5ff' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 90,
    content: '为完善丰台区普惠金融服务体系，提升金融服务覆盖面和便民程度，更好服务实体经济发展，制定本指导意见。重点推进普惠金融服务站点建设，丰台区金融服务办公室协调推进各项工作落实。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_012',
    title: '丰台区金融消费者权益保护工作实施办法',
    originalTitle: '北京市丰台区金融服务办公室关于印发丰台区金融消费者权益保护工作实施办法的通知',
    tags: [
      { text: '实施办法', type: 'category', color: '#9254de', bgColor: '#f9f0ff' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 87,
    content: '为加强丰台区金融消费者权益保护工作，规范金融机构经营行为，提升金融消费者满意度，根据相关法律法规，制定本实施办法。丰台区金融服务办公室负责统筹协调全区金融消费者权益保护工作。',
    policyType: 'policy'
  },
  {
    id: 'fengtai_finance_013',
    title: '丰台区金融业对外开放合作促进办法',
    originalTitle: '北京市丰台区人民政府关于印发丰台区金融业对外开放合作促进办法的通知',
    tags: [
      { text: '促进办法', type: 'category', color: '#ff85c0', bgColor: '#fff0f6' },
      { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
    ],
    ...
    matchScore: 86,
    content: '为深化丰台区金融业对外开放，促进国际金融合作，吸引境外金融机构和资本参与区域发展，制定本促进办法。重点支持跨境金融服务、国际金融合作等项目，丰台区金融服务办公室负责政策实施和项目管理。',
    policyType: 'policy'
  }
];
...
export const fengtaiFinancialProject: PolicyFileData = {
  ...
  tags: [
    { text: '申报项目', type: 'category', color: '#52c41a', bgColor: '#f6ffed' },
    { text: '区级', type: 'level', color: '#1890ff', bgColor: '#e6f7ff' }
  ],
  ...
  matchScore: 99,
  content: '根据《丰台区金融业发展专项资金管理办法》，现启动2024年度专项资金申报工作。本次申报重点支持金融机构创新发展、金融科技应用、普惠金融服务等项目。丰台区金融服务办公室负责项目评审和资金拨付工作。',
  policyType: 'project',
