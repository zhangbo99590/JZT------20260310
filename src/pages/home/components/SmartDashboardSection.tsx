...
export const SmartDashboardSection: React.FC<SmartDashboardSectionProps> = ({
  loading = false,
}) => {
  ...
  const handleDelete = async () => {
    ...
    if (
      !result.success &&
      result.message !== "删除操作被 beforeDelete 钩子取消"
    ) {
      ...
      children: (
        <Row gutter={[16, 16]}>
          <Col xs={24} lg={12}>
            <div style={{ height: "300px" }}>
              <SafeECharts
                option={getPolicyDistributionOption(policyTypeData)}
                style={{ height: "100%", width: "100%" }}
              />
            </div>
          </Col>
          <Col xs={24} lg={12}>
            <div style={{ height: "300px" }}>
              <SafeECharts
                option={getFundFlowOption(fundFlowData)}
                style={{ height: "100%", width: "100%" }}
              />
            </div>
          </Col>
                    ...
                    <Col span={4}>
                      <div style={{ textAlign: "center" }}>
                        <Text
                          ...
                          style={{
                            color:
                              item.successRate > 80 ? "#52c41a" : "#fa8c16",
                          }}
                        >
                          {item.successRate}%
                        </Text>
