...
import { SearchOutlined, FilterOutlined, BulbOutlined, ReloadOutlined } from '@ant-design/icons';
      ...
      <Space direction="vertical" size={16} style={{ width: '100%', maxWidth: 400, margin: '0 auto' }}>
        ...
        <Card size="small" style={{ background: '#f8f9fa', border: '1px solid #e9ecef' }}>
          <Space direction="vertical" size={8} style={{ width: '100%' }}>
            ...
            <ul style={{ margin: 0, paddingLeft: 16, color: '#6c757d', fontSize: 13 }}>
              <li>尝试使用更通用的关键词</li>
              <li>检查关键词拼写是否正确</li>
              <li>减少筛选条件的限制</li>
              <li>尝试相关的同义词</li>
      ...
      <Empty
        ...
        description={
          <div>
            ...
            <Paragraph style={{ color: '#999', fontSize: 16, marginBottom: 32 }}>
